...
function persistState(sessionId) {
  let deserializeState = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _identity.default;
  let deserializeAction = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : _identity.default;
  if (!sessionId) {
  ...
  function deserialize(state) {
    return {
      ...state,
      actionsById: (0, _mapValues.default)(state.actionsById, liftedAction => ({
        ...liftedAction,
